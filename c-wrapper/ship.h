...
DGMPP_EXTERN dgmpp_bool dgmpp_ship_add_module		(dgmpp_type ship, dgmpp_type module);
...
DGMPP_EXTERN dgmpp_bool							dgmpp_capacitor_is_stable			(dgmpp_capacitor capacitor);
